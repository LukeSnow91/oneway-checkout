 ...
 * Handles refunds
 */
abstract class WC_Gateway_Pacypay_Response {

	/** @var bool Sandbox mode */
	protected $sandbox = false;

	/**
	 * Get the order from the Pacypay 'track_id' variable
	 *
	 * @param  string $track_id, $sub_track_id
	 * @return bool|WC_Order object
	 */
	protected function get_pacypay_order($track_id, $sub_track_id) {
		...
		if ( ! $order || $order->order_key !== $sub_track_id ) {
			WC_Gateway_Pacypay::log( 'Error: Order Keys do not match.' );
			return false;
		}
